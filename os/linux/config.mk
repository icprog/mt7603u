...
HAS_CFG80211_P2P_STATIC_CONCURRENT_DEVICE=y
...
#Country Region module parameter
HAS_MODULE_PARAM_COUNTRY_REGION=n

#PID VID module parameter
HAS_MODULE_PARAM_PID_VID=n
...
HAS_MODULE_PARAM_PID_VID=y
HAS_MODULE_PARAM_COUNTRY_REGION=y
HAS_FW_SS_COMMAND=y
...
WFLAGS += -DRT_CFG80211_P2P_STATIC_CONCURRENT_DEVICE -DRT_CFG80211_P2P_CONCURRENT_DEVICE
else
...
ifeq ($(HAS_MODULE_PARAM_COUNTRY_REGION),y)
WFLAGS += -DMODULE_PARAM_COUNTRY_REGION
endif

ifeq ($(HAS_MODULE_PARAM_PID_VID),y)
WFLAGS += -DMODULE_PARAM_PID_VID
endif

ifeq ($(HAS_FW_SS_COMMAND),y)
WFLAGS += -DFW_SS_COMMAND
endif
