...
enum EXT_CMD_TYPE {
    ...
    EXT_CMD_ID_CCN5_WOW_Setting = 0x34
};
...
#ifdef FW_SS_COMMAND
typedef struct _EXT_CMD_CNN5_CTRL_T {
	UINT8 ucAssistent;
	UINT8 ucFilterSrcIP[4];
	UINT8 ucReserve[3];
} EXT_CMD_CNN5_CTRL_T;
#endif
...
#ifdef FW_SS_COMMAND
INT32 CmdCNN5WowSetAssistent(struct _RTMP_ADAPTER *pAd, UINT8 Value);
INT32 CmdCNN5WowSetFilterIP(struct _RTMP_ADAPTER *pAd, UINT8 *IP);
#endif
