...
#endif /* RT_CFG80211_SUPPORT */
#ifdef FW_SS_COMMAND
	UINT8 IpAddr[4]; /* Store the WiFi IP address */
	UINT32 SSwowMode; //0 : no wake-ip ; 1:Eevent 1; 2:Event 2 enable ; 3: Event 1 and Event 2 both enable
	UINT8 Pattern; //0:TypeA ;1:Type B
	BOOLEAN waker_mac_check; //1:enable ; 0: Disable
	BOOLEAN waker_pw_check;   //1:enable ; 0: Disable
	UINT8 FilterSrcIpAddr[4]; /* Store the WiFi Filter IP address */
	UINT8 Assistant; /* Set Assistant enable */
#endif	
